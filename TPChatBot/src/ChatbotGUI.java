...
public class ChatbotGUI {
    ...
    private void appendTextWithStyle(JTextPane textPane, String text, boolean isBold, boolean isRightAligned) {
    ...
    if (isRightAligned) {
        StyleConstants.setAlignment(attrs, StyleConstants.ALIGN_RIGHT); // Alignement à droite pour l'utilisateur
    } else {
        StyleConstants.setAlignment(attrs, StyleConstants.ALIGN_LEFT); // Alignement à gauche pour le chatbot
    }
